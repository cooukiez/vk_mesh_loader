...
void App::create_query_pool(const uint32_t loc_frame_query_count) {
...
void App::render() {
    ...
    const VkSemaphore wait_semps[] = {img_avl_semps[cur_frame]};
    ...
    const VkSemaphore signal_semps[] = {rend_fin_semps[cur_frame]};
